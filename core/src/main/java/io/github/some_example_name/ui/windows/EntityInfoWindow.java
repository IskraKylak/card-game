...
public class EntityInfoWindow extends Window {

  public EntityInfoWindow(CombatEntity entity, Skin skin) {
    super("Entity Info", skin);
    ...
    Label statsLabel = new Label(
        "ATK: " + entity.getAttackPower() + " | HP: " + entity.getHealth() + "/" + entity.getMaxHealth(),
        skin, "default");

    Texture texture = new Texture(entity.getSpriteFolder() + "/idle1.png");
